...
public interface CurrencyDao extends JpaRepository<ZxlCurrency, Integer>,JpaSpecificationExecutor<ZxlCurrency> {
    ...
    @Query(value = "select zc.id,zc.currency_name,zc.currency_decimals_num,zc.currency_buy_fee,zc.currency_sell_fee,zc.currency_url,zc.max_withdraw,zc.min_withdraw,zc.fee_withdraw," +
